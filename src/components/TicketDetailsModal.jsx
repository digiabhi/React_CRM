    ...
    return (
        <dialog id="ticket_modal" className="modal">
            <div className="modal-box">
                ...
                <textarea name="description" className="bg-white text-black rounded-lg resize-none p-2 w-full" cols="50" rows="7" value={currentTicket.description}
                    onChange={handleTicketChange}></textarea>
